Shader "HDRP/VisibilityOIT"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define SHADERPASS SHADERPASS_VISIBILITY_OIT_COUNT
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassVisibilityOIT.hlsl"
