...
namespace UnityEngine.Experimental.Rendering
{
    ...
    internal class ProbeVolumeAsset : ScriptableObject
    {
        ...
        // To acess binary data shared between states (injected on load)
        internal ProbeVolumePerSceneData data;
        ...
        internal bool ResolveCells(TextAsset cellDataAsset, TextAsset cellOptionalDataAsset, TextAsset cellSharedDataAsset, TextAsset cellSupportDataAsset)
        {
            ...
            var cellSupportData = data.cellSupportDataAsset ? data.cellSupportDataAsset.GetData<byte>() : default;
        ...
        public static ProbeVolumeAsset CreateAsset(ProbeVolumePerSceneData data, ProbeVolumeAsset previous)
        {
            ProbeVolumeAsset asset = CreateInstance<ProbeVolumeAsset>();
            if (previous != null) asset.m_AssetFullPath = UnityEditor.AssetDatabase.GetAssetPath(previous);
